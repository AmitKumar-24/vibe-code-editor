    ...
    <div className=" z-20 flex flex-col items-center justify-start min-h-screen py-2 mt-10">
      <div className="flex flex-col justify-center items-center my-1">
        ...
        <h1 className=" z-20 text-6xl mt-5 font-extrabold text-center bg-clip-text text-transparent bg-gradient-to-r from-rose-500 via-red-500 to-pink-500 dark:from-rose-400 dark:via-red-400 dark:to-pink-400 tracking-tight leading-[1.3] ">
          ...
          Code Smarter with VibeCode
        </h1>
      </div>

      <p className="mt-1 text-lg text-center text-gray-600 dark:text-gray-400 px-5 py-8 max-w-2xl">
        ...
        efficiently. */}
        VibeCode Editor is your smart companion for writing clean, efficient
        code. Packed with intelligent features and smooth integrations, it’s
        built to elevate your workflow—whether you are writing, debugging, or
        optimizing.
      </p>
      <Link href={"/dashboard"}>
